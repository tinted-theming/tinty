...
# Allow users to optionally configure where their base16-shell-manager config is
...
# Allow users to optionally configure their base16-shell-manager path and set
